...
const Pagers = props => {
    if (props.useContext) {
        return (React.createElement(ScrollConsumer, null, context => (React.createElement(PagerBase, { dark: props.dark, page: context.page, pages: context.pages, prefix: context.anchors, progress: context.progress, showLabels: props.showLabels }))));
    }
...
const Skip = props => {
    if (props.useContext) {
        return React.createElement(ScrollConsumer, null, context => React.createElement(SkipBase, { prefix: context.anchors }));
    }
    assert(props.prefix, "string");
...
export { assert, Pager, StyledMarker, Marker, Icon, SkipLink, SkipBase, PagerBase, Pagers, Skip };
