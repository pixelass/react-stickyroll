...
var tracker = require('@stickyroll/tracker');
...
class Frame extends React.Component {
    constructor() {
        ...
        this.Wrapper = ({ children }) => (React.createElement(React.Fragment, null,
            React.createElement(tracker.Tracker, { onUpdate: this.handleUpdate, throttle: this.props.throttle }),
    ...
    render() {
        ...
        switch (typeof render) {
            ...
            // Context based
            default:
                return (React.createElement(context.ScrollProvider, { value: { anchors, page, pages: pageCount, progress } },
                    React.createElement(Wrapper, null,
                        React.createElement(context.ScrollConsumer, null, children))));
        }
    }
    /**
     * @type {React.CSSProperties}
